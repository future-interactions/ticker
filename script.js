addEventListener("load", function () {
  ...
  for (let i = 0; i < numOfTickers1; i++) {
    ...
    tickerList1[i].style.backgroundColor = "hsl(" + i * 5 + ", 100%, 50%)";
  ...
  for (let i = 0; i < numOfTickers2; i++) {
    ...
    tickerList2[i].style.backgroundColor = "hsl(" + i * 15 + ", 100%, 50%)";
  ...
  for (let i = 0; i < numOfTickers3; i++) {
    ...
    tickerList3[i].style.backgroundColor = "hsl(" + i * 5 + ", 100%, 50%)";
  ...
  for (let i = 0; i < numOfTickers4; i++) {
    ...
    tickerList4[i].style.backgroundColor = "hsl(" + i * 20 + ", 100%, 50%)";
    startPos4[i] = i * mainLength4;
    tickerList4[i].style.left = startPos4[i];
    tickerList4[i].style.top = "74vh";
  }
